#ifndef  CY_PROCESS_MGR_H
#define CY_PROCESS_MGR_H
#include<string>
namespace cy{
namespace  process{
using namespace std;
...
public:
	...
	BOOL KillByDir(LPCTSTR dir,LPCTSTR ignore);
	BOOL KillByPath(LPCTSTR lpPath);
	BOOL KillByCMD(LPCTSTR lpCommondLine);

#if X_SUPPORT_CSTRING
	BOOL GetFullPath(LPCTSTR lpPath, wstring& strFullPath);		// 通过一个部分路径来获取全部路径
#endif
